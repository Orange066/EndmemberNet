...
for sample_id in sample_id_l:
    ...
    dc_l.append(sum(dcs) / len(dcs))
    jc_l.append(sum(jcs) / len(jcs))

print()
print('average')
print('All average dc', sum(dc_l)/len(dc_l))
print('All average jc', sum(jc_l)/len(jc_l))
